...
export default function ChatsMenu({ session }: {session: Session | null}) {
    ...
    const styling = {
        mainWrapper: "flex flex-col w-2/5 h-full border-2 border-borderWhite",
        profileWrapper: "flex items-center gap-x-4 h-16 pl-5 border-b-2 border-borderWhite",
        searchBar: {
            wrapper: "flex items-center gap-x-3 h-12 pl-5 border-b-2 border-borderWhite",
